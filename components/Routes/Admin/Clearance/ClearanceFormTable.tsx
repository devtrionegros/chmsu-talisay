      ...
      <div className="relative flex  h-[430px] w-full flex-col rounded-[10px] border-[1px] border-gray-200 bg-white bg-clip-border shadow-md shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none">
        <div className="flex h-fit w-full items-center justify-between rounded-t-2xl bg-white px-4 pb-[20px] pt-4 shadow-2xl shadow-gray-100 dark:!bg-navy-700 dark:shadow-none">
          ...
          <div className="space-x-2">
            <button className="linear rounded-[20px] bg-lightPrimary px-4 py-2 text-base font-medium text-brand-500 transition duration-200 hover:bg-blue-100 active:bg-gray-200 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 dark:active:bg-white/20">
              Add approver
            </button>
            <button className="linear rounded-[20px] bg-lightPrimary px-4 py-2 text-base font-medium text-brand-500 transition duration-200 hover:bg-blue-100 active:bg-gray-200 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 dark:active:bg-white/20">
              See all
        ...
        <div className="w-full overflow-x-scroll px-4 md:overflow-x-hidden">
          ...
          >
            <thead>
              <tr role="row">
                <th title="Toggle SortBy" className=" cursor-pointer">
                ...
                <td className="py-3 text-sm" role="cell">
                  <div className="mx-2 flex font-bold">
                    <div className="h-2 w-16 rounded-full bg-gray-200 dark:bg-navy-700">
                      <div className="flex w-[30%] h-full items-center justify-center rounded-md bg-brand-500 dark:bg-brand-400"></div>
                    </div>
                  </div>
                </td>
              </tr>
...
export default ClearanceFormTable;
