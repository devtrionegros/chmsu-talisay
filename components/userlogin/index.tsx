    ...
    <div className='wrapper flex justify-center items-center min-h-screen bg-[#65F779] ' style={{
      ...
      style={{
        ...
        <nav className="navigation"> 
            <button className="btnLogin-popup w-24 h-10 bg-transparent rounded-md cursor-pointer text-white ml-10 border-2 border-[#000]-600 outline-none text-sm font-bold transition bg-transparent text-[#000]">Login</button>
        </nav> 
    </header>
        <div className="wrapper relative w-[51vh] h-[51vh] bg-opacity-0  border-2 border-solid border-white border-opacity-50 rounded-[20px] backdrop-blur-[2px] shadow-[0_0_30px_rgba(0,0,0,0.5)] flex justify-center items-center overflow-hidden  border-[#fff]">
 ...
 <div className="w-[100%] p-[60px] form-box absolute">
            ...
            <form action="#">
                <div className="input-box relative w-full h-16 border-b-2 border-[#162938] my-8">
                    ...
                    <input type="email" placeholder="."  className='  w-full h-full  border-none outline-none text-base text-blue-900 pl-5 pr-0 py-0 bg-[transparent]' required />
                ...
                <button type="submit" className="btn w-full h-12 bg-[#162938] rounded-lg focus:outline-none cursor-pointer text-base font-semibold text-white mt-[10%] text-[#fff]">Login</button>
