...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gradient-to-r from-purple-400 to-indigo-500">
      {loggedIn ? (
          ...
          <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
            <div className="p-4 py-6 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
              ...
              <p className="mt-6 font-normal text-center text-gray-300 md:mt-0">
                ...
                Perferendis consequatur unde blanditiis eius, pariatur obcaecati
                saepe id hic labore aliquid nobis quibusdam quisquam molestias!
                Hic est veniam dignissimos ipsum rerum?
              </p>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col space-y-5">
                <div className="flex flex-col space-y-1">
                  ...
                  <input
                    ...
                    id="email"
                    autoFocus
                    className="px-4 py-2 transition text-gray-400 duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200"
                  />
                </div>
                <div className="flex flex-col space-y-1">
